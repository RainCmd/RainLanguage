...
KernelLibraryInfo::KernelLibraryInfo() :root(NULL), data(64), variables(0), enums(KERNEL_TYPE_ENUM_COUNT), structs(KERNEL_TYPE_STRUCT_COUNT), classes(KERNEL_TYPE_CLASS_COUNT), interfaces(0), delegates(0), tasks(0), functions(0), dataStrings(0), stringAgency(1024)
{
	...
	//Operation
	{
		...
		REGISTER_SPECIAL_FUNCTIONS(true, root, TEXT("=="), KERNEL_SPECIAL_FUNCTION_Equals_ReflectionVariable, CreateTypeList(TYPE_Bool), CreateTypeList(TYPE_Reflection_Variable, TYPE_Reflection_Variable), Operation_Equals_ReflectionVariable);
		REGISTER_SPECIAL_FUNCTIONS(true, root, TEXT("=="), KERNEL_SPECIAL_FUNCTION_Equals_ReflectionMemberConstructor, CreateTypeList(TYPE_Bool), CreateTypeList(TYPE_Reflection_MemberConstructor, TYPE_Reflection_MemberConstructor), Operation_Equals_ReflectionMemberConstructor);
		REGISTER_SPECIAL_FUNCTIONS(true, root, TEXT("=="), KERNEL_SPECIAL_FUNCTION_Equals_ReflectionMemberVariable, CreateTypeList(TYPE_Bool), CreateTypeList(TYPE_Reflection_MemberVariable, TYPE_Reflection_MemberVariable), Operation_Equals_ReflectionMemberVariable);
		REGISTER_SPECIAL_FUNCTIONS(true, root, TEXT("=="), KERNEL_SPECIAL_FUNCTION_Equals_ReflectionMemberFunction, CreateTypeList(TYPE_Bool), CreateTypeList(TYPE_Reflection_MemberFunction, TYPE_Reflection_MemberFunction), Operation_Equals_ReflectionMemberFunction);
		REGISTER_SPECIAL_FUNCTIONS(true, root, TEXT("=="), KERNEL_SPECIAL_FUNCTION_Equals_ReflectionFunction, CreateTypeList(TYPE_Bool), CreateTypeList(TYPE_Reflection_Function, TYPE_Reflection_Function), Operation_Equals_ReflectionFunction);
		REGISTER_SPECIAL_FUNCTIONS(true, root, TEXT("=="), KERNEL_SPECIAL_FUNCTION_Equals_ReflectionNative, CreateTypeList(TYPE_Bool), CreateTypeList(TYPE_Reflection_Native, TYPE_Reflection_Native), Operation_Equals_ReflectionNative);
		...
		REGISTER_SPECIAL_FUNCTIONS(true, root, TEXT("!="), KERNEL_SPECIAL_FUNCTION_Not_Equals_ReflectionVariable, CreateTypeList(TYPE_Bool), CreateTypeList(TYPE_Reflection_Variable, TYPE_Reflection_Variable), Operation_Not_Equals_ReflectionVariable);
		REGISTER_SPECIAL_FUNCTIONS(true, root, TEXT("!="), KERNEL_SPECIAL_FUNCTION_Not_Equals_ReflectionMemberConstructor, CreateTypeList(TYPE_Bool), CreateTypeList(TYPE_Reflection_MemberConstructor, TYPE_Reflection_MemberConstructor), Operation_Not_Equals_ReflectionMemberConstructor);
		REGISTER_SPECIAL_FUNCTIONS(true, root, TEXT("!="), KERNEL_SPECIAL_FUNCTION_Not_Equals_ReflectionMemberVariable, CreateTypeList(TYPE_Bool), CreateTypeList(TYPE_Reflection_MemberVariable, TYPE_Reflection_MemberVariable), Operation_Not_Equals_ReflectionMemberVariable);
		REGISTER_SPECIAL_FUNCTIONS(true, root, TEXT("!="), KERNEL_SPECIAL_FUNCTION_Not_Equals_ReflectionMemberFunction, CreateTypeList(TYPE_Bool), CreateTypeList(TYPE_Reflection_MemberFunction, TYPE_Reflection_MemberFunction), Operation_Not_Equals_ReflectionMemberFunction);
		REGISTER_SPECIAL_FUNCTIONS(true, root, TEXT("!="), KERNEL_SPECIAL_FUNCTION_Not_Equals_ReflectionFunction, CreateTypeList(TYPE_Bool), CreateTypeList(TYPE_Reflection_Function, TYPE_Reflection_Function), Operation_Not_Equals_ReflectionFunction);
		REGISTER_SPECIAL_FUNCTIONS(true, root, TEXT("!="), KERNEL_SPECIAL_FUNCTION_Not_Equals_ReflectionNative, CreateTypeList(TYPE_Bool), CreateTypeList(TYPE_Reflection_Native, TYPE_Reflection_Native), Operation_Not_Equals_ReflectionNative);
	...
	//struct type
	{
		...
		REGISTER_MEMBER_FUNCTIONS(true, TEXT("CreateDelegate"), CreateTypeList(TYPE_Delegate), CreateTypeList(TYPE_Type, TYPE_Reflection_MemberFunction, TYPE_Handle, TYPE_Bool), type_CreateDelegate3);
		...
		REGISTER_MEMBER_FUNCTIONS(true, TEXT("CreateTask"), CreateTypeList(TYPE_Task), CreateTypeList(TYPE_Type, TYPE_Reflection_MemberFunction, TYPE_Handle, Type(TYPE_Handle, 1), TYPE_Bool), type_CreateTask2);
	...
	//space System
	{
		...
		//space Exceptions
		{
			...
			REGISTER_VARIABLE(true, exceptionSpace, TEXT("InvalidOperation"), TYPE_String, AddData(EXCEPTION_INVALID_OPERATION));
			REGISTER_VARIABLE(true, exceptionSpace, TEXT("InvalidReflection"), TYPE_String, AddData(EXCEPTION_INVALID_REFLECTION));
		}
	...
	//space Reflection
	{
		...
		//struct Variable
		{
			List<KernelLibraryInfo::Variable> memberVariables = List<KernelLibraryInfo::Variable>(5);
			REGISTER_MEMBER_VARIABLES(true, TEXT("readonly"), TYPE_Bool, GET_FIELD_OFFSET(ReflectionVariable, readonly));
			...
			REGISTER_STRUCT(true, space, TEXT("Variable"), KERNEL_TYPE_STRUCT_INDEX_Reflection_Variable, SIZE(ReflectionVariable), MEMORY_ALIGNMENT_4, memberVariables, memberFunctions);
		}
		//struct MemberConstructor
		{
			List<KernelLibraryInfo::Variable> memberVariables = List<KernelLibraryInfo::Variable>(2);
			REGISTER_MEMBER_VARIABLES(true, TEXT("isPublic"), TYPE_Bool, GET_FIELD_OFFSET(ReflectionMemberConstructor, isPublic));
			REGISTER_MEMBER_VARIABLES(true, TEXT("declaringType"), TYPE_Type, GET_FIELD_OFFSET(ReflectionMemberConstructor, declaringType));
			List<uint32, true> memberFunctions = List<uint32, true>(4);
			...
			REGISTER_STRUCT(true, space, TEXT("MemberConstructor"), KERNEL_TYPE_STRUCT_INDEX_Reflection_MemberConstructor, SIZE(ReflectionMemberConstructor), MEMORY_ALIGNMENT_4, memberVariables, memberFunctions);
		}
		//struct MemberVariable
		{
			List<KernelLibraryInfo::Variable> memberVariables = List<KernelLibraryInfo::Variable>(5);
			REGISTER_MEMBER_VARIABLES(true, TEXT("readonly"), TYPE_Bool, GET_FIELD_OFFSET(ReflectionMemberVariable, readonly));
			REGISTER_MEMBER_VARIABLES(true, TEXT("isPublic"), TYPE_Bool, GET_FIELD_OFFSET(ReflectionMemberVariable, isPublic));
			REGISTER_MEMBER_VARIABLES(true, TEXT("declaringType"), TYPE_Type, GET_FIELD_OFFSET(ReflectionMemberVariable, declaringType));
			REGISTER_MEMBER_VARIABLES(true, TEXT("name"), TYPE_String, GET_FIELD_OFFSET(ReflectionMemberVariable, name));
			REGISTER_MEMBER_VARIABLES(true, TEXT("variableType"), TYPE_Type, GET_FIELD_OFFSET(ReflectionMemberVariable, variableType));
			List<uint32, true> memberFunctions = List<uint32, true>(4);
		...
		{
			List<KernelLibraryInfo::Variable> memberVariables = List<KernelLibraryInfo::Variable>(3);
			REGISTER_MEMBER_VARIABLES(true, TEXT("isPublic"), TYPE_Bool, GET_FIELD_OFFSET(ReflectionMemberFunction, isPublic));
			REGISTER_MEMBER_VARIABLES(true, TEXT("declaringType"), TYPE_Type, GET_FIELD_OFFSET(ReflectionMemberFunction, declaringType));
			REGISTER_MEMBER_VARIABLES(true, TEXT("name"), TYPE_String, GET_FIELD_OFFSET(ReflectionMemberFunction, name));
			...
			REGISTER_MEMBER_FUNCTIONS(true, TEXT("Invoke"), CreateTypeList(Type(TYPE_Handle, 1)), CreateTypeList(TYPE_Reflection_MemberFunction, TYPE_Handle, Type(TYPE_Handle, 1), TYPE_Bool), Reflection_MemberFunction_Invoke);
			REGISTER_STRUCT(true, space, TEXT("MemberFunction"), KERNEL_TYPE_STRUCT_INDEX_Reflection_MemberFunction, SIZE(ReflectionMemberFunction), MEMORY_ALIGNMENT_4, memberVariables, memberFunctions);
		}
		//struct Function
		{
			List<KernelLibraryInfo::Variable> memberVariables = List<KernelLibraryInfo::Variable>(3);
			REGISTER_MEMBER_VARIABLES(true, TEXT("isPublic"), TYPE_Bool, GET_FIELD_OFFSET(ReflectionFunction, isPublic));
			REGISTER_MEMBER_VARIABLES(true, TEXT("owningSpace"), TYPE_Handle, GET_FIELD_OFFSET(ReflectionFunction, owningSpace));
			REGISTER_MEMBER_VARIABLES(true, TEXT("name"), TYPE_String, GET_FIELD_OFFSET(ReflectionFunction, name));
			List<uint32, true> memberFunctions = List<uint32, true>(5);
		...
		{
			List<KernelLibraryInfo::Variable> memberVariables = List<KernelLibraryInfo::Variable>(3);
			REGISTER_MEMBER_VARIABLES(true, TEXT("isPublic"), TYPE_Bool, GET_FIELD_OFFSET(ReflectionNative, isPublic));
			REGISTER_MEMBER_VARIABLES(true, TEXT("owningSpace"), TYPE_Handle, GET_FIELD_OFFSET(ReflectionNative, owningSpace));
			REGISTER_MEMBER_VARIABLES(true, TEXT("name"), TYPE_String, GET_FIELD_OFFSET(ReflectionNative, name));
			List<uint32, true> memberFunctions = List<uint32, true>(5);
			...
			REGISTER_STRUCT(true, space, TEXT("Native"), KERNEL_TYPE_STRUCT_INDEX_Reflection_Native, SIZE(ReflectionNative), MEMORY_ALIGNMENT_4, memberVariables, memberFunctions);
		}
		//class Space
		{
