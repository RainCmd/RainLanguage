...
KernelLibraryInfo::KernelLibraryInfo() :root(NULL), data(64), variables(0), enums(KERNEL_TYPE_ENUM_COUNT), structs(KERNEL_TYPE_STRUCT_COUNT), classes(KERNEL_TYPE_CLASS_COUNT), interfaces(0), delegates(0), coroutines(0), functions(0), dataStrings(0), stringAgency(1024)
{
	...
	//Operation
	{
		...
		REGISTER_SPECIAL_FUNCTIONS(true, root, "*", KERNEL_SPECIAL_FUNCTION_Mul_real2_real, CreateTypeList(TYPE_Real), CreateTypeList(TYPE_Real, TYPE_Real), Operation_Mul_real2_real);
		REGISTER_SPECIAL_FUNCTIONS(true, root, "*", KERNEL_SPECIAL_FUNCTION_Mul_real3_real, CreateTypeList(TYPE_Real), CreateTypeList(TYPE_Real, TYPE_Real), Operation_Mul_real3_real);
		REGISTER_SPECIAL_FUNCTIONS(true, root, "*", KERNEL_SPECIAL_FUNCTION_Mul_real4_real, CreateTypeList(TYPE_Real), CreateTypeList(TYPE_Real, TYPE_Real), Operation_Mul_real4_real);
		REGISTER_SPECIAL_FUNCTIONS(true, root, "*", KERNEL_SPECIAL_FUNCTION_Mul_real_real2, CreateTypeList(TYPE_Real), CreateTypeList(TYPE_Real, TYPE_Real), Operation_Mul_real_real2);
		REGISTER_SPECIAL_FUNCTIONS(true, root, "*", KERNEL_SPECIAL_FUNCTION_Mul_real_real3, CreateTypeList(TYPE_Real), CreateTypeList(TYPE_Real, TYPE_Real), Operation_Mul_real_real3);
		REGISTER_SPECIAL_FUNCTIONS(true, root, "*", KERNEL_SPECIAL_FUNCTION_Mul_real_real4, CreateTypeList(TYPE_Real), CreateTypeList(TYPE_Real, TYPE_Real), Operation_Mul_real_real4);
		REGISTER_SPECIAL_FUNCTIONS(true, root, "*", KERNEL_SPECIAL_FUNCTION_Mul_real2_real2, CreateTypeList(TYPE_Real), CreateTypeList(TYPE_Real, TYPE_Real), Operation_Mul_real2_real2);
		REGISTER_SPECIAL_FUNCTIONS(true, root, "*", KERNEL_SPECIAL_FUNCTION_Mul_real3_real3, CreateTypeList(TYPE_Real), CreateTypeList(TYPE_Real, TYPE_Real), Operation_Mul_real3_real3);
		REGISTER_SPECIAL_FUNCTIONS(true, root, "*", KERNEL_SPECIAL_FUNCTION_Mul_real4_real4, CreateTypeList(TYPE_Real), CreateTypeList(TYPE_Real, TYPE_Real), Operation_Mul_real4_real4);
	...
	//struct type
	{
		...
		REGISTER_MEMBER_FUNCTIONS(true, "StartCoroutine", CreateTypeList(TYPE_Handle), CreateTypeList(TYPE_Type, TYPE_Reflection_Function, Type(TYPE_Handle, 1)), type_StartCoroutine);
		REGISTER_MEMBER_FUNCTIONS(true, "StartCoroutine", CreateTypeList(TYPE_Handle), CreateTypeList(TYPE_Type, TYPE_Reflection_MemberFunction, TYPE_Handle, Type(TYPE_Handle, 1)), type_StartCoroutine2);
