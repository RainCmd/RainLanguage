...
Library* GetKernelLibrary()
{
	if(!kernelLibrary)
	{
		...
		kernelLibrary = new Library(new StringAgency(1024), library->data, library->data.Count(), library->functions.Count(), library->variables.Count(), library->enums.Count(), library->structs.Count(), library->classes.Count(), library->interfaces.Count(), library->delegates.Count(), library->tasks.Count(), library->functions.Count(), 0, 0, 0, 0, 0);
