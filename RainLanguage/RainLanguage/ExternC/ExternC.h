...
extern "C"
{
	...
	RAINLANGUAGE void Extern_InvokerWrapperAbort(InvokerWrapper* invoker);
	...
	RAINLANGUAGE bool Extern_InvokerWapperSetBoolParameters(InvokerWrapper* invoker, uint32 index, bool* value, uint32 count);
	RAINLANGUAGE bool Extern_InvokerWapperSetByteParameters(InvokerWrapper* invoker, uint32 index, uint8* value, uint32 count);
	RAINLANGUAGE bool Extern_InvokerWapperSetCharParameters(InvokerWrapper* invoker, uint32 index, character* value, uint32 count);
	RAINLANGUAGE bool Extern_InvokerWapperSetIntegerParameters(InvokerWrapper* invoker, uint32 index, integer* value, uint32 count);
	RAINLANGUAGE bool Extern_InvokerWapperSetRealParameters(InvokerWrapper* invoker, uint32 index, Extern_Real* value, uint32 count);
	RAINLANGUAGE bool Extern_InvokerWapperSetReal2Parameters(InvokerWrapper* invoker, uint32 index, Extern_Real2* value, uint32 count);
	RAINLANGUAGE bool Extern_InvokerWapperSetReal3Parameters(InvokerWrapper* invoker, uint32 index, Extern_Real3* value, uint32 count);
	RAINLANGUAGE bool Extern_InvokerWapperSetReal4Parameters(InvokerWrapper* invoker, uint32 index, Extern_Real4* value, uint32 count);
	RAINLANGUAGE bool Extern_InvokerWapperSetEnumValueParameters(InvokerWrapper* invoker, uint32 index, integer* value, uint32 count);
	RAINLANGUAGE bool Extern_InvokerWapperSetEnumNameParameters(InvokerWrapper* invoker, uint32 index, const character** name, uint32 count);
	RAINLANGUAGE bool Extern_InvokerWapperSetStringParameters(InvokerWrapper* invoker, uint32 index, const character** value, uint32 count);
	RAINLANGUAGE bool Extern_InvokerWapperSetEntityParameters(InvokerWrapper* invoker, uint32 index, uint64* value, uint32 count);
	...
	RAINLANGUAGE bool Extern_CallerWrapperSetBoolReturnValues(CallerWrapper* caller, uint32 index, bool* values, uint32 length);
	RAINLANGUAGE bool Extern_CallerWrapperSetByteReturnValues(CallerWrapper* caller, uint32 index, uint8* values, uint32 length);
	RAINLANGUAGE bool Extern_CallerWrapperSetCharReturnValues(CallerWrapper* caller, uint32 index, character* values, uint32 length);
	RAINLANGUAGE bool Extern_CallerWrapperSetIntegerReturnValues(CallerWrapper* caller, uint32 index, integer* values, uint32 length);
	RAINLANGUAGE bool Extern_CallerWrapperSetRealReturnValues(CallerWrapper* caller, uint32 index, Extern_Real* values, uint32 length);
	RAINLANGUAGE bool Extern_CallerWrapperSetReal2ReturnValues(CallerWrapper* caller, uint32 index, Extern_Real2* values, uint32 length);
	RAINLANGUAGE bool Extern_CallerWrapperSetReal3ReturnValues(CallerWrapper* caller, uint32 index, Extern_Real3* values, uint32 length);
	RAINLANGUAGE bool Extern_CallerWrapperSetReal4ReturnValues(CallerWrapper* caller, uint32 index, Extern_Real4* values, uint32 length);
	RAINLANGUAGE bool Extern_CallerWrapperSetEnumNameReturnValues(CallerWrapper* caller, uint32 index, character** values, uint32 length);
	RAINLANGUAGE bool Extern_CallerWrapperSetEnumValueReturnValues(CallerWrapper* caller, uint32 index, integer* values, uint32 length);
