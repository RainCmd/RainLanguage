...
enum class ExpressionType :uint64
{
	...
	VirtualFunctionDelegateCreateExpression = 1ull << 17,
	InvokerConstructorExpression = 1ull << 18,
	ArrayEvaluationExpression = 1ull << 19,
	ConstantCharExpression = 1ull << 20,
	ConstantIntegerExpression = 1ull << 21,
	ConstantRealExpression = 1ull << 22,
	ConstantNullExpression = 1ull << 23,
	TypeExpression = 1ull << 24,
	ExpressionReferenceExpression = 1ull << 25,
	VariableClosureExpression = 1ull << 26,
};
