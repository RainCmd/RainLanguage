...
struct FunctionGenerator
{
	...
	void ParseBranch(GeneratorParameter& parameter, List<Statement*, true>& statements, const Anchor& anchor, Context context, LocalContext* localContext, bool destructor);
