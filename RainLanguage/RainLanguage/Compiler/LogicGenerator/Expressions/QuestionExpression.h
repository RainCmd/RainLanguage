...
public:
	...
	inline QuestionExpression(const Anchor& anchor, Expression* condition, Expression* left, Expression* right) :Expression(ExpressionType::QuestionExpression, anchor, left->returns), condition(condition), left(left), right(right)
	{
