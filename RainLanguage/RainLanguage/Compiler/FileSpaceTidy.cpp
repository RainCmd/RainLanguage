...
#define REGISTER_DECLARATION(declaration,visibility,type,set,define) CompilingDeclaration* declaration = new (declarations->Add())CompilingDeclaration(LIBRARY_SELF, visibility, type, set.Count(), define);
