namespace LanguageServer.Parameters.TextDocument
{
    ...
    public struct Color
    {
        ...
        private const double MaxByte = byte.MaxValue;
        ...
        /// </summary>
        public readonly string RGBA => $"rgba({RedByte}, {GreenByte}, {BlueByte}, {DiscreteAlpha})";

        /// <summary>
        /// Gets the RGB value of this <c>Color</c> structure as a six digit hex value
        /// with a leading hash character like <c>#ffffff</c>.
        /// </summary>
        public readonly string HexRGB => $"#{RedByte:x2}{GreenByte:x2}{BlueByte:x2}";
        ...
        /// </summary>
        public readonly string HexRGBA => $"#{RedByte:x2}{GreenByte:x2}{BlueByte:x2}{AlphaByte:x2}";
